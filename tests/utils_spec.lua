...
describe('utils.set_wrap_keymaps and unset_wrap_keymaps', function()
  ...
  it('calls vim.keymap.set for mappings and remappings', function()
    ...
    local cfg = { mappings = { n = { { enabled = true, map = {'n','gj','<cmd>echo gj<cr>', {silent=true}} } } }, remappings = {} }
  ...
  it('calls vim.keymap.del for mappings with table modes', function()
    ...
    local cfg = { mappings = { n = { { enabled = true, map = {{'n','v'},'gj','<cmd>echo gj<cr>', {silent=true}} } } }, remappings = {} }
  ...
  it('macro helpers reflect vim.fn', function()
    ...
    vim.fn.reg_executing = function() return 'a' end
    vim.fn.reg_recording = function() return '' end
