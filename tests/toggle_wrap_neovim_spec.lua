...
describe("togglewrap.toggle_wrap (neovim mode)", function()
    ...
    before_each(function()
        ...
        package.loaded["vscode-neovim-fix-word-wrap.utils"] = {
            set_wrap_keymaps = function(_)
                called_set = true
            end,
            unset_wrap_keymaps = function(_)
                called_unset = true
            end,
            get_vscode_wrap = function()
        ...
        package.loaded["vscode-neovim-fix-word-wrap.config"] = {
            ...
            build_runtime_keymaps = function()
                return { mappings = { n = {}, v = {}, o = {} }, remappings = {} }
            end,
        }
        ...
        vim.opt_global =
            { wrap = false, linebreak = false, formatoptions = { remove = function() end, append = function() end } }
